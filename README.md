...
Transform saved YouTube videos into searchable, AI-powered summaries. Never lose track of valuable video content again.

## 📋 Overview

Stash solves the common problem of saving videos for later but never revisiting them. The application automatically extracts transcripts from YouTube videos and generates intelligent, structured summaries using AI, making your saved content instantly searchable and accessible.
